...
import 'package:fudamiku/views/screens/delicious_today_page.dart';
import 'package:fudamiku/views/screens/newly_posted_page.dart';
import 'package:fudamiku/views/screens/profile_page.dart';
import 'package:fudamiku/views/screens/search_page.dart';
import 'package:fudamiku/views/utils/app_color.dart';
import 'package:fudamiku/views/widgets/custom_app_bar.dart';
import 'package:fudamiku/views/widgets/dummy_search_bar.dart';
import 'package:fudamiku/views/widgets/featured_recipe_card.dart';
import 'package:fudamiku/views/widgets/recipe_tile.dart';
import 'package:fudamiku/views/widgets/recommendation_recipe_card.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(
        title: Text('Fudamiku', style: TextStyle(fontFamily: 'inter', fontWeight: FontWeight.w700)),
